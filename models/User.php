...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public static function getReceiversQuery()
    {
        return User::find()->where(['not in','role',['administrator','author']])->all();
    }

    public static function getSenders()
    {
        $users = User::find()->where(['in','role',['administrator','author']])->all();
    ...
    {
        $users = User::find()->where(['not in','role',['administrator','author']])->all();
        return ArrayHelper::map($users,'id',function($model){
            return $model->first_name.' '.$model->last_name;
        });
